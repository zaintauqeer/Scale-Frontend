...
//               </div>
//               <div className="flex justify-between items-center">
//                 <span className="font-medium text-lg">Price per Unit:</span>
//                 <span className="text-lg">{cartItem.pricePerUnit} SAR</span>
//               </div>
//               <div className="flex justify-between items-center">
...
//       {/* Sidebar Checkout */}
//       {isCheckoutOpen && (
//         <div className="fixed inset-0 z-50 flex justify-end" style={{ backgroundColor: "rgba(0, 0, 0, 0.8)" }}>
//           <div className="w-full max-w-md bg-white h-full shadow-lg transform transition-transform duration-300 ease-in-out" style={{ transform: isCheckoutOpen ? "translateX(0)" : "translateX(100%)" }}>
...
//                     <h2 className="text-2xl font-semibold mb-4 text-gray-700">{cartItem.title.en}</h2>
//                     <p className="text-lg text-gray-600">Price: {cartItem.pricePerUnit} / Unit</p>
//                   </div>
...
//                 </>
//               ) : (
//                 <p className="text-center text-gray-500 text-lg">No item in cart.</p>
//               )}
//             </div>
//           </div>
//         </div>
