    ...
    <div className='bg-[#1A3D38] lg:py-[117px] lg:px-[103px] px-[37px] py-[45px]'>
      <div className="flex flex-wrap gap-y-14 items-center">
        ...
        <div className='lg:w-3/5 w-full flex justify-end lg:gap-5 gap-3 flex-wrap'>
          <Link href={`/${pathname?.split("/")[1]}/deals`} className="bg-[#F15625] text-white lg:px-11 px-7 lg:py-5 py-2.5 rounded-sm inline-block menu-btn leading-[1.2] lg:text-xl text-xs font-['Outfit-SemiBold'] border rtl:font-sans rtl:font-semibold border-[#F15625] lg:grow-0 grow text-center">{g('viewLiveDeals')}</Link>
          <Link
