...
const HeroSection = () => {
  ...
  return (
    <Swiper loop={true} autoplay={{ delay: 5000 }} spaceBetween={50} modules={[Autoplay]}>
    <div className='relative isolate bg-[url("/hero-bg.png")] bg-cover bg-center bg-no-repeat lg:px-12 px-3 lg:py-14 py-8'>
  ...
  {slides.map((slide, index) => (
    <SwiperSlide key={index}>
      ...
      <div
        className='relative isolate bg-cover bg-center bg-no-repeat lg:px-12 px-3 lg:py-14 py-8'
        style={{
      ...
      >
        ...
        <div className="flex">
          ...
          <div className="lg:w-1/2 lg:flex hidden justify-end items-end">
            ...
            >
              <img src="icons/whatsapp-logo.svg" alt="" className='w-20'/>
