...
const HeroSection = () => {
    return (
        <div className='relative isolate bg-[url("/hero-bg.png")] bg-cover bg-center bg-no-repeat lg:m-8 m-4 lg:px-12 px-3 py-14 rounded-[20px]'>
            ...
            <div className='text-white pt-96 lg:w-1/2 '>
                ...
                <Link href='/deals' className=" text-white px-5 py-5 rounded-sm inline-block menu-btn leading-[1.2] lg:text-xl text-xs font-['Outfit-SemiBold'] border border-white ml-5">Order via whatsapp</Link>
                </div>
            </div>
        </div>
    )
