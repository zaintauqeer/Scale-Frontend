                        ...
                        <div className="w-1/2">
                            <div className="mb-8 text-center  w-max flex items-center">
                                <div className='place-items-center lg:w-[135px] w-24'>
                                    ...
                                    <h6 className='font-[Outfit-Bold] rtl:font-sans rtl:font-bold lg:text-base text-xs max-w-32'>{t('Browse Ongoing Group Deals')}</h6>
                                </div>
                            ...
                            <div className="mb-8 text-center  w-max flex items-center">
                                <div className='place-items-center lg:w-[135px] w-24'>
                                    ...
                                    <h6 className='font-[Outfit-Bold] rtl:font-sans rtl:font-bold lg:text-base text-xs max-w-32'>{t('Join the Deal via WhatsApp')}</h6>
                                </div>
                            ...
                            <div className="mb-8 text-center  w-max flex items-center">
                                <div className='place-items-center lg:w-[135px] w-24'>
                                    ...
                                    <h6 className='font-[Outfit-Bold] rtl:font-sans rtl:font-bold lg:text-base text-xs max-w-32'>{t('Get Delivery When the Deal Closes')}</h6>
                                </div>
                                <img src="/icons/arrow.svg" className='lg:-rotate-12 -rotate-45 origin-left lg:w-28 w-20' alt="" />
                            </div>
                        </div>
