      ...
      <div className="flex flex-wrap gap-y-4">
        <div className="lg:w-1/2 w-full">
          ...
          <div className="flex justify-between items-baseline">
            <h2 className="text-5xl font-[Outfit-Bold] rtl:font-sans rtl:font-bold my-5 max-w-lg">
              {t("title")}
            </h2>
          </div>
          ...
          <div className="mt-16 flex gap-x-3">
            ...
            <div>
              <h6 className="text-xl font-[Outfit-Medium] rtl:font-sans rtl:font-medium text-[#222222]">
                {t("Chat with us on WhatsApp")}
              </h6>
              <a
                className="text-xl text-[#5C90EB]"
                href="mailto:hello@scaleksa.com"
              >
                hello@scaleksa.com
              </a>
            </div>
