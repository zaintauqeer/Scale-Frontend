    ...
    <div className="lg:px-20 px-5 py-14 flex flex-col lg:flex-row gap-x-12">
      ...
      <div className="flex flex-col gap-5 lg:w-7/12">
        ...
        <div className="flex gap-4 mt-12">
          ...
          <a href={`https://wa.me/966551324666?text=${whatsappMessages[locale]}`} className="bg-[#F05526] flex-auto text-center text-white py-3 rounded font-semibold hover:bg-[#d63f1e] transition-colors cursor-pointor">
            {t("Join now")}
          </a>
