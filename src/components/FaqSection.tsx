      ...
      <div className="flex flex-wrap gap-y-16">
        <div className="lg:ps-10 lg:w-2/6 w-full lg:pe-7">
          ...
          <div className="bg-[#F05526] py-5 px-6 mt-10 rounded-xl">
            <h4 className="flex items-center gap-x-2 text-white lg:text-xl font-[Outfit-Bold] rtl:font-sans rtl:font-bold"><img src="icons/chat-icon.svg" alt="" /> {t('question')}</h4>
            <p className="lg:text-lg mt-2 text-[#FFFFFF99]">{t('answer')}</p>
            <Link href= {`/${pathname?.split("/")[1]}/#contact-us`} className="lg:py-3 lg:px-11 py-2 px-4 text-[#1A3D38] font-[Outfit-SemiBold] rtl:font-sans rtl:font-semibold bg-[#FFFFFF] rounded-sm inline-block mt-5">{t('contact')}</Link>
          </div>
        </div>
